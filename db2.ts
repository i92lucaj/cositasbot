const data = {
    ...
    admins: {
        DESCRIPTION: "Muestra los admins",
        EXTENDED_DESCRIPTION:
    ...
    promote: {
        DESCRIPTION: "ROCIO ALONSO HA TOMADO EL GRUPO.....",
        EXTENDED_DESCRIPTION:
            "```ES MUY JAKER LA ROCIO NOOOOOOOO```",
    ...
    sticker: {
        ...
        DOWNLOADING: "```Tranquilo, tenemos a Pedro Nieto haciendo magia para crear el sticker```"
    },
    stoi: {
